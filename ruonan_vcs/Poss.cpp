...
void Poss(Int_t RunNum = 0, Int_t HMS_xmax1 = 0, Int_t HMS_xmax2 = 0, Int_t SHMS_xmax1 = 0, Int_t SHMS_xmax2 = 0)
{
	if(RunNum == 0) {
	...
	TH1F *hist_hDCREF1_full = new TH1F("hist_hDCREF1_full","T.coin.hDCREF1_tdcTimeRaw",200,0,20000);
	...
	//	hist_pTRIG4_ROC2_full->Fill(*pTRIG4_ROC2_TimeRaw);
		...
		int HMS_bmin = hist_hDCREF1_full->GetXaxis()->FindBin(0.);
		int HMS_bmax1 = hist_hDCREF1_full->GetXaxis()->FindBin(HMS_xmax1);
		int HMS_bmax2 = hist_hDCREF1_full->GetXaxis()->FindBin(HMS_xmax2);
		double HMS_integral1 = hist_hDCREF1_full->Integral(HMS_bmin, HMS_bmax1);
		double HMS_integral2 = hist_hDCREF1_full->Integral(HMS_bmin, HMS_bmax2);
		double HMS_percentage = HMS_integral1/HMS_integral2/1.;
		...
		int SHMS_bmin = hist_pDCREF1_full->GetXaxis()->FindBin(0.);
		int SHMS_bmax1 = hist_pDCREF1_full->GetXaxis()->FindBin(SHMS_xmax1);
		int SHMS_bmax2 = hist_pDCREF1_full->GetXaxis()->FindBin(SHMS_xmax2);
		double SHMS_integral1 = hist_pDCREF1_full->Integral(SHMS_bmin, SHMS_bmax1);
		double SHMS_integral2 = hist_pDCREF1_full->Integral(SHMS_bmin, SHMS_bmax2);
